<template>
    <div>
        <h3>{{ useTrans('step5')?.health?.title }}</h3>
        ...
        <step-5-measures-modal :id="54" :title="useTrans('step5')?.health?.title" :modalMeasures="modalMeasures" :modalInformations="modalInformations" :modalFrecuencies="modalFrecuencies" :modalBenefits="modalBenefits"/>
    </div>
</template>
...
export default {
    ...
    data(){
        return {
            modalMeasures: this.useTrans('step5')?.health?.modalMeasures,
            modalInformations: this.useTrans('step5')?.health?.modalInformations,
            modalFrecuencies: this.useTrans('step5')?.health?.modalFrecuencies,
            modalBenefits: [
                "1-19",
                "20-49",
                "50-99",
